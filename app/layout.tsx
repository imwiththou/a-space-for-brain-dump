...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <html lang="en">
      <body
        className={`antialiased min-h-screen bg-white dark:bg-black text-slate-950 dark:text-slate-50 ${inter.className}`}
      >
          ...
          <div className="max-w-3xl mx-auto py-10 px-4">
            <header className="w-full">
              <div className="flex items-center justify-between">
                <ModeToggle />
                <nav className="ml-auto text-sm font-medium space-x-6 no-underline hover:underline md:no-underline">
                  <Link href="/">Home</Link>
